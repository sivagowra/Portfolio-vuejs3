    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
                ...
                <div class="space-y-8 py-2">
                    ...
                    >
                        ...
                        <div class="w-3/4 pl-4">
                            <h4 class="text-2xl font-semibold uppercase text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary lg:text-xl">
                                Kallam Haranadhareddy Institute of Technology
                            </h4>
                            <p class="text-white">B.Tech in Computer Science Engineering</p>
                            <p class="text-white">2019 – 2022</p>
                        </div>
                    </div>
                </div>
                <div class="space-y-8 py-2">
                    ...
                    >
                        ...
                        <div class="w-3/4 pl-4">
                            <h3 class="text-2xl font-semibold uppercase text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary lg:text-xl">
                                Divi Seema Polytechnic College
                            </h3>
                            <p class="text-white">Diploma in Computer Science Engineering</p>
                            <p class="text-white">2016 – 2019</p>
                        </div>
                    </div>
                </div> <div class="space-y-4 py-2">
                    <div
                    class="flex items-center md:w-[80%] w-full rounded-xl bg-[#111a3e] shadow-lg border border-[#1f1641]"
                    >
                        <div class="w-1/4">
                        ...
                        <div class="w-3/4 pl-4">
                            <h3 class="text-2xl font-semibold uppercase text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary lg:text-xl">
                                Z.P. High School</h3>
                            <p class="text-white">10th Class (SSC)</p>
                            <p class="text-white">2015 – 2016</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8">I'm a passionate and detail-oriented UI Developer with 1 year of hands-on experience at FINSE Technologies Pvt. Ltd., where I contributed to the development and maintenance of dynamic web applications. My tech toolkit includes HTML, CSS, JavaScript, Tailwind CSS, Vue.js, TypeScript, and Bootstrap, and I enjoy crafting clean, responsive user interfaces that deliver great user experiences!
                </p>
