            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        I specialize in crafting dynamic and responsive web interfaces using Vue.js, JavaScript, TypeScript, HTML, Tailwind CSS, and Bootstrap. With a strong foundation in Python and Java, I bring logic-driven development into my UI work. I’m passionate about building clean, intuitive user experiences that solve real-world problems. I thrive in collaborative, fast-paced environments and constantly seek to expand my skill set. My focus is on creating efficient, scalable, and visually engaging web applications.                    </p>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        ...
                        <button class=" border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            ...
                            <a href="./resume.pdf" download class="resume-btn pl-4 text-orange-500">Download Resume</a>
                        </div>
                        </button>
                    </div>
                </div>
                <div class="lg:h-full md:flex">
                    <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                        ...
                        <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-primary">
                            <img src="https://i.pinimg.com/736x/3f/ba/6e/3fba6e9784b22e1d6910afff7697f265.jpg" alt="Hero pic" width="600" height="auto" loading="lazy"
