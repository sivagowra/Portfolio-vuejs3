<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">I'm always excited to meet new people, collaborate on exciting projects, or just have a great conversation about tech, UI/UX, and development!
                ...
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>https://www.linkedin.com/in/gowra-sivannarayana-b17798222/</p>
                        </div>
                    </div>
                </div>
            </div>
